...
TAGS: builtin_types float concept gotcha
---
...
TAGS: builtin_types float concept
---
...
TAGS: builtin_types float gotcha
---
...
TAGS: builtin_types float decimal gotcha
---
...
TAGS: builtin_types float decimal concept
---
...
TAGS: builtin_types float nan gotcha
---
...
TAGS: builtin_types float nan inf concept
---
...
TAGS: builtin_types float inf gotcha
---
...
A: `1 == 1.0` and `hash(1) == hash(1.0)`, so they are the same dict key; the later value wins, leaving `{1: "b"}`.
TAGS: builtin_types float dict gotcha
---
